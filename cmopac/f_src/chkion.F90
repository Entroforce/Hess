subroutine chkion (ox_calc, n_lone_pairs, atom_charge)
   ...
   !***********************************************************************
    ...
    use molkst_C, only : numat, nelecs, line
...
!                              Isolated atom (Most of these will never exist, e.g. C)
    data ox_ref &
        ...
        &  1, 2,                                              3, 4, 3,-2,-1, 0, &!   10
        &  1, 2,                                              3, 4, 3,-2,-1, 0, &!   18
        &  1, 2, 2,              4, 3, 2, 3, 2, 3, 2, 1, 2,   3, 4, 3,-2,-1, 0, &!   36
        &  1, 2, 2,              4, 3, 2, 3, 2, 3, 2, 1, 2,   3, 4, 3,-2,-1, 0, &!   54
        &  1, 2, 2, 14*3,        4, 3, 2, 3, 2, 3, 2, 1, 2,   3, 2, 3,-2,-1, 0, &!   86
...
!
    data ox_ref_sp &
        ...
        &  1, 2, 2,              4, 3, 2, 3, 2, 3, 2, 1, 2,   3, 4, 3,-2, 1, 0, &!   36
        &  1, 2, 2,              4, 3, 2, 3, 2, 3, 2, 1, 2,   3, 4, 3,-2, 1, 0, &!   54
        &  1, 2, 2, 5*0,3*2,6*2, 4, 3, 2, 3, 2, 3, 2, 1, 2,   3, 2, 3,-2, 0, 0, &!   86
        &  1, 2, 2, 4, 2, 2,     4, 3, 2, 3, 2, 3, 2, 0, 0,   0, 0, 0, 0, 0, 0 /
!
...
!
    data ox_ref_spd1 &
        ...
        &  1, 2,                                              3, 4, 3,-2,-1, 0, &!   10
        &  1, 2,                                              3, 4, 5, 6, 3, 0, &!   18
        &  1, 2, 2,              4, 5, 6, 7, 2, 3, 2, 1, 2,   3, 4, 5, 6, 3, 0, &!   36
        &  1, 2, 2,              4, 5, 6, 7, 2, 3, 2, 1, 2,   3, 4, 5, 6, 3, 0, &!   54
        &  1, 2, 2, 5*0,3*2,6*2, 4, 5, 6, 7, 2, 3, 2, 1, 2,   3, 2, 3, 4, 0, 0, &!   86
        &  1, 2, 2, 4, 2, 2,     4, 5, 6, 7, 2, 3, 2, 0, 0,   0, 0, 0, 0, 0, 0 /
!
