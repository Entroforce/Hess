...
!
  ...
  &  ijpars,     & !
  &  dummy2
  real(double), dimension(3,3), target :: tvec !  Translation vectors (for solid-state)
  integer, bind(C) ::         &
...
!
  real(double), dimension (:), allocatable, target :: &
  ...
  character, dimension (:), allocatable, target :: &
...
subroutine getNfirst(ptr) bind(C, name="getNfirst")
  type(c_ptr), intent(out) :: ptr

  ptr = c_loc(nfirst(1))
end subroutine

subroutine getNlast(ptr) bind(C, name="getNlast")
  type(c_ptr), intent(out) :: ptr

  ptr = c_loc(nlast(1))
end subroutine

subroutine getNat(ptr) bind(C, name="getNat")
  type(c_ptr), intent(out) :: ptr

  ptr = c_loc(nat(1))
end subroutine

subroutine getXparam(ptr) bind(C, name="getXparam")
  type(c_ptr), intent(out) :: ptr

  ptr = c_loc(xparam(1))
end subroutine

subroutine getGrad(ptr) bind(C, name="getGrad")
  type(c_ptr), intent(out) :: ptr

  ptr = c_loc(grad(1))
end subroutine

subroutine getNw(ptr) bind(C, name="getNw")
  type(c_ptr), intent(out) :: ptr

  ptr = c_loc(nw(1))
end subroutine

subroutine getP(ptr) bind(C, name="getP")
  type(c_ptr), intent(out) :: ptr

  ptr = c_loc(p(1))
end subroutine

subroutine getTxtatm(ptr) bind(C, name="getTxtatm")
  type(c_ptr), intent(out) :: ptr

  ptr = c_loc(txtatm(1))
end subroutine

subroutine getGeo(ptr) bind(C, name="getGeo")
  type(c_ptr), intent(out) :: ptr

  ptr = c_loc(geo(1,1))
end subroutine

subroutine getQ(ptr) bind(C, name="getQ")
  type(c_ptr), intent(out) :: ptr

  ptr = c_loc(q(1))
end subroutine

subroutine getLoc(ptr) bind(C, name="getLoc")
  type(c_ptr), intent(out) :: ptr

  ptr = c_loc(loc(1,1))
end subroutine

subroutine getNa(ptr) bind(C, name="getNa")
  type(c_ptr), intent(out) :: ptr

  ptr = c_loc(na(1))
end subroutine

subroutine getNb(ptr) bind(C, name="getNb")
  type(c_ptr), intent(out) :: ptr

  ptr = c_loc(nb(1))
end subroutine

subroutine getNc(ptr) bind(C, name="getNc")
  type(c_ptr), intent(out) :: ptr

  ptr = c_loc(nc(1))
end subroutine

subroutine getCoord(ptr) bind(C, name="getCoord")
  type(c_ptr), intent(out) :: ptr

  ptr = c_loc(coord(1,1))
end subroutine

subroutine getXparef(ptr) bind(C, name="getXparef")
  type(c_ptr), intent(out) :: ptr

  ptr = c_loc(xparef(1))
end subroutine

subroutine getTvec(ptr) bind(C, name="getTvec")
  type(c_ptr), intent(out) :: ptr

  ptr = c_loc(tvec(1,1))
end subroutine

subroutine getLabels(ptr) bind(C, name="getLabels")
  type(c_ptr), intent(out) :: ptr

  ptr = c_loc(labels(1))
end subroutine

subroutine getF(ptr) bind(C, name="getF")
  type(c_ptr), intent(out) :: ptr

  ptr = c_loc(f(1))
end subroutine

subroutine getLopt(ptr) bind(C, name="getLopt")
  type(c_ptr), intent(out) :: ptr

  ptr = c_loc(lopt(1,1))
end subroutine

subroutine getAtmass(ptr) bind(C, name="getAtmass")
  type(c_ptr), intent(out) :: ptr
