...
!
      ...
      data     gss7( 40)/         4.852088D0/
      data     gsp7( 40)/         5.870297D0/
      data     gpp7( 40)/        14.606622D0/
      data     gp27( 40)/        12.729367D0/
      data     hsp7( 40)/         0.151362D0/
...
!
      data   polvo7( 99)/         0.791396D0/
      data gues71( 99,1)/         8.947612D0/ ! = PAR1
      data gues72( 99,1)/         6.024265D0/ ! = PAR2
      data gues73( 99,1)/        -0.012037D0/ ! = PAR3
      data gues71( 99,2)/         0.701333D0/ ! = PAR4
      data gues72( 99,2)/        15.450118D0/ ! = PAR5
      data gues73( 99,2)/         1.226593D0/ ! = PAR6
      data gues71( 99,3)/         2.286419D0/ ! = PAR7
      data gues72( 99,3)/        -0.171271D0/ ! = PAR8
      data gues73( 99,3)/        -0.098822D0/ ! = PAR9
      data gues71( 99,4)/        -0.308057D0/ ! = PAR10
!
!                    Data for Element 100       3+ Sparkle
!
      data     alp7(100)/         1.500000D0/
      data   polvo7(100)/         0.373638D0/
!
