...
LDLIBSOPTIONS=../hess-se/dist/Debug/GNU-Linux/libhess-se.a ../hess-base/dist/Debug/GNU-Linux/libhess-base.a ../indigo/dist/Debug/GNU-Linux/libindigo.a ../cmopac/dist/Debug/GNU-Linux/libcmopac.a -lpthread -lz

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/hess-se-docking

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/hess-se-docking: ../hess-se/dist/Debug/GNU-Linux/libhess-se.a

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/hess-se-docking: ../hess-base/dist/Debug/GNU-Linux/libhess-base.a

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/hess-se-docking: ../indigo/dist/Debug/GNU-Linux/libindigo.a

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/hess-se-docking: ../cmopac/dist/Debug/GNU-Linux/libcmopac.a
...
${OBJECTDIR}/main.o: main.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -I../hess-base/src/parser -I../hess-base/src -I../hess-base/src/interface -I../hess-base/src/model -I../hess-base/src/bond -I../hess-base/src/empirical-docking -I../indigo/Indigo/api/c/indigo -I../indigo/Indigo/third_party/object_threadsafe -I../indigo/Indigo/third_party/rapidjson -I../indigo/Indigo/third_party/tinyxml2 -I../indigo/Indigo/third_party/inchi/INCHI_BASE/src -I../indigo/Indigo/third_party/cppcodec/cppcodec -I../indigo/Indigo/third_party/cppcodec -I../indigo/Indigo/core/indigo-core -I../indigo/Indigo/core/indigo-core/common/base_c -I../indigo/Indigo/core/indigo-core/common/base_cpp -I../indigo/Indigo/core/indigo-core/molecule -I../indigo/Indigo/core/indigo-core/common -I../indigo/Indigo -I../hess-se/src/interface -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.c

# Subprojects
.build-subprojects:
	cd ../hess-se && ${MAKE}  -f Makefile CONF=Debug
	cd ../hess-base && ${MAKE}  -f Makefile CONF=Debug
	cd ../indigo && ${MAKE}  -f Makefile CONF=Debug
	cd ../cmopac && ${MAKE}  -f Makefile CONF=Debug
